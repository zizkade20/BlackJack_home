...
namespace BlackJack
{
    internal class Balicek
    {
        ...
        internal void CreateDeck()
        {
            ...
            Hrac1.Penize -= sazka;
            //if (int.TryParse(sazka, out value))
...
namespace BlackJack
{
    internal class Balicek
    {
        ...
        internal List<Karta> Lizni(int Pocet, List<Karta> Karty) {
                
            List<string> DeckOfCards = new List<string>();

            foreach (var i in Karty)
            {
                DeckOfCards.Add(i.VratNazevKarty());
            }
           

            List<Karta> PlayerCards = new List<Karta>();
            //List<string> DealerCards = new List<string>();
